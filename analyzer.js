...
class PatternAnalyzer {
  ...
  /**
   * Return a detached copy of the most recent analyzer
   * diagnostics generated by detectAllPatterns().
   *
   * The orchestrator may persist this observation data,
   * but cannot mutate the analyzer's internal state.
   */
  getLastDiagnostics() {
    if (
      !this.lastDiagnostics ||
      typeof this.lastDiagnostics !==
        "object"
    ) {
      return null;
    }
